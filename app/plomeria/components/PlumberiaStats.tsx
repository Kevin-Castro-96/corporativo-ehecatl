    ...
    <section className="py-20 bg-linear-to-r from-blue-600 via-blue-700 to-teal-600 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mt-20 text-center">
          ...
          <button onClick={handleWhatsAppClick} className="bg-white text-blue-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl">
            Más Información
          </button>
        </div>
      </div>
