			...
			<div className='container mx-auto px-4'>
				...
				<div className='bg-linear-to-r from-yellow-600 to-orange-600 rounded-3xl p-8 md:p-12 text-center text-white'>
					...
					<div className='flex flex-col sm:flex-row gap-4 justify-center'>
						<button className='flex items-center justify-center bg-white text-yellow-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300'>
							<PhoneIcon />
